...
export async function savePaymentMethod(stylistId: string, methodName: string, accountNumber: string) {
  if (typeof stylistId !== 'string') throw new Error('stylistId must be a string');
...
export async function EditPaymentMethod(id: string, methodName: string, accountNumber: string) {
